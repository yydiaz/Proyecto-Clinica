...
In ClinicaDelValle-labels_en.properties:
ClinicaDelValle=My application
ClinicaDelValle[description]=My application does this and that

In ClinicaDelValle-messages_en.properties:
